...
void dp_triangle(u_short bgr, u_short size, u_short ptY, u_short ptX, u_short reg);
void dp_square(u_short bgr, u_short size, u_short ptY, u_short ptX, u_short reg);
